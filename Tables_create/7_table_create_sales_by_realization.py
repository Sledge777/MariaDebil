...
def create_tables(cursor):
    print("Создание таблицы sales_by_realization...", end='')
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS sales_by_realization (
    ...
    with open(file_path, 'r', encoding='utf-8-sig') as f:
        ...
        for row in reader:
            ...
            try:
                ...
                # НЕ отбрасываем время!

                cursor.execute("""
                    INSERT INTO sales_by_realization (
        ...
        print(f"✅ Загружено {count} записей в таблицу sales_by_realization. Коммит выполнен в: {commit_time}")
...
if __name__ == "__main__":
    ...
    file_path = r'C:\Users\root\Desktop\Final\reports\sales_by_realization.txt'
